                    ...
                    <div class="row mt--30">
                        <div class="col-xl-6 col-lg-6 mt-30 wow fadeInUp animated">
                            <div class="single-product-box one">
                                <div v-if="product && product.product_images && product.product_images.length > 0" class="big-product single-product-one slider-for" >

                                    <div v-for="productImage in product.product_images">
                                        <div class="single-item">
                                            <img  v-bind:src="productImage.url" alt="">
                                            <div class="ptag"> <span class="one">-20% </span>
                                            </div> <a href="#0"  class="love"> <i class="flaticon-like"></i> </a>
                                        </div>
                                    </div>
                                </div>

                                <div v-if="product && product.product_images && product.product_images.length > 0" class="navholder">
                        ...
                        <div class="col-xl-6 col-lg-6 mt-30 wow fadeInUp animated">
                            <div class="shop-details-top-right ">
                                <div class="shop-details-top-right-content-box">
                                    ...
                                    <p class="shop-details-top-product-sale"><span></span> {{ product.description }}
                                    </p>
                                    ...
                                    <div class="shop-details-top-color-sky-box">
                                        ...
                                        <ul class="varients">
                                            <li><a href="#0" class="shop-details-top-color-sky-img"
                                                   data-src="http://127.0.0.1:5173/src/assets/images/shop/products-img1.jpg">
                                                <img
                                                        src="http://127.0.0.1:5173/src/assets/images/shop/shop-details-top-color-sky-img-1.jpg"
                                                        alt=""> </a></li>
                                            <li><a href="#0" class="shop-details-top-color-sky-img"
                                                   data-src="http://127.0.0.1:5173/src/assets/images/shop/products-img2.jpg">
                                                <img
                                                        src="http://127.0.0.1:5173/src/assets/images/shop/shop-details-top-color-sky-img-2.jpg"
                                                        alt=""> </a></li>
                                            <li><a href="#0" class="shop-details-top-color-sky-img"
                                                   data-src="http://127.0.0.1:5173/src/assets/images/shop/products-img3.jpg">
                                                <img
                                                        src="http://127.0.0.1:5173/src/assets/images/shop/shop-details-top-color-sky-img-3.jpg"
                                                        alt=""> </a></li>
                                            <li><a href="#0" class="shop-details-top-color-sky-img"
                                                   data-src="http://127.0.0.1:5173/src/assets/images/shop/products-img4.jpg">
                                                <img
                                                        src="http://127.0.0.1:5173/src/assets/images/shop/shop-details-top-color-sky-img-4.jpg"
                                                        alt=""> </a></li>
                                        </ul>
                                    </div>
                                        ...
                                        <ul class="shop-details-top-safe-checkout-list">
                                            <li>
                                                <div class="shop-details-top-safe-checkout-img"><a href="#0"><img
                                                        src="http://127.0.0.1:5173/src/assets/images/shop/shop-details-top-safe-checkout-img-1.jpg"
                                                        alt=""></a></div>
                                            </li>
                                            <li>
                                                <div class="shop-details-top-safe-checkout-img"><a href="#0"><img
                                                        src="http://127.0.0.1:5173/src/assets/images/shop/shop-details-top-safe-checkout-img-2.jpg"
                                                        alt=""></a></div>
                                            </li>
                                            <li>
                                                <div class="shop-details-top-safe-checkout-img"><a href="#0"><img
                                                        src="http://127.0.0.1:5173/src/assets/images/shop/shop-details-top-safe-checkout-img-3.jpg"
                                                        alt=""></a></div>
                                            </li>
                                            <li>
                                                <div class="shop-details-top-safe-checkout-img"><a href="#0"><img
                                                        src="http://127.0.0.1:5173/src/assets/images/shop/shop-details-top-safe-checkout-img-4.jpg"
                                                        alt=""></a></div>
                                            </li>
                                            <li>
                                                <div class="shop-details-top-safe-checkout-img"><a href="#0"><img
                                                        src="http://127.0.0.1:5173/src/assets/images/shop/shop-details-top-safe-checkout-img-5.jpg"
                                                        alt=""></a></div>
                                            </li>
                                            <li>
                                                <div class="shop-details-top-safe-checkout-img"><a href="#0"><img
                                                        src="http://127.0.0.1:5173/src/assets/images/shop/shop-details-top-safe-checkout-img-7.jpg"
                                                        alt=""></a></div>
                                            </li>
                                        </ul>
                                    </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="popup-right-content">
                                                    ...
                                                    <div class="payment-method"><a href="#0"> <img
                                                            src="http://127.0.0.1:5173/src/assets/images/payment_method/method_1.png"
                                                            alt=""> </a>
                                                        <a href="#0"> <img
                                                                src="http://127.0.0.1:5173/src/assets/images/payment_method/method_2.png"
                                                                alt=""> </a> <a href="#0"> <img
                                                                src="http://127.0.0.1:5173/src/assets/images/payment_method/method_3.png"
                                                                alt=""> </a>
                                                        <a href="#0"> <img
                                                                src="http://127.0.0.1:5173/src/assets/images/payment_method/method_4.png"
                                                                alt=""> </a></div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="products-grid-one">
                                ...
                                <div class="products-grid-one__thumb-box">
                                    ...
                                    <p class="products-grid-one__product-varient"><span class="color"> green </span>
                                        <img
                                                src="http://127.0.0.1:5173/src/assets/images/shop/products-img8.jpg"
                                                alt="Alt"></p>
                                </div>
                            </div>
                            <div class="products-grid-one">
                                <div class="products-grid-one__product-image"><a href="shop-details-1.html"
                                    ...
                                    <img
                                            class="products-grid-one__mainimage products-grid-one__first-img"
                                            src="http://127.0.0.1:5173/src/assets/images/shop/products-img12.jpg"
                                            alt="Alt"> <img
                                        class="products-grid-one__hover-img"
                                        src="http://127.0.0.1:5173/src/assets/images/shop/products-img11.jpg"
                                        alt="Alt"> </a>
                                    <div class="products-grid__usefull-links">
                                        <ul>
                                            <li><a href="wishlist.html"> <i class="flaticon-heart"> </i> <span>
                                                    ...
                                                    <div class="tabs">
                                                        <div class="popup-product-thumb-box">
                                                            <ul>
                                                                <li class="tab-nav popup-product-thumb"><a
                                                                        href="#ttab111">
                                                                    <img src="http://127.0.0.1:5173/src/assets/images/shop/products-img9.jpg"
                                                                         alt="img"> </a></li>
                                                                <li class="tab-nav popup-product-thumb "><a
                                                                        href="#ttab222"> <img
                                                                        src="http://127.0.0.1:5173/src/assets/images/shop/products-img10.jpg"
                                                                        alt="img"> </a></li>
                                                                <li class="tab-nav popup-product-thumb "><a
                                                                        href="#ttab333"> <img
                                                                        src="http://127.0.0.1:5173/src/assets/images/shop/products-img11.jpg"
                                                        ...
                                                        <div class="popup-product-main-image-box">
                                                            <div id="ttab111" class="tab-item popup-product-image">
                                                                <div class="popup-product-single-image"><img
                                                                        src="http://127.0.0.1:5173/src/assets/images/shop/products-img9.jpg"
                                                                        alt="img"></div>
                                                            </div>
...
export default {
    ...
    methods: {
        getProduct(id) {
            this.axios.get(`http://127.0.0.1/api/products/${this.$route.params.id}`)
                .then(res => {
                    this.product = res.data.data;
                    console.log(this.product.product_images[0].url);

                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="popup-right-content">
                                                                        ...
                                                                        <div class="color-varient">
                                                                            ...
                                                                            <a @click.prevent="getProduct(groupProduct.id)" v-for="color in groupProduct.colors" href="#0" :style="`background:#${color.title};`" class="color-name pink"> <span>Pink</span> </a>
                                                                            </template>
                                                                        </div>
